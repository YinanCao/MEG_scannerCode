...
cd('/home/usera/Documents/MEGpilot/Documents/experiments/attention_cueing_MEG/')
...
for block = 1:2
    ...
    disp('ET calibrating')
    [el, info] = ELconfig(window, ['sub',num2str(info.SubNo),'_sess',...
        num2str(session),'_b',num2str(block)], info, screenNumber);
    % Calibrate the eye tracker
    EyelinkDoTrackerSetup(el);
    end
