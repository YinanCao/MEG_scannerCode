...
if strcmp(info.kb_setup,'MEG')
    ...
    info.kbqdev = [idx(strcmpi(names, 'ATEN USB KVMP w. OSD')),...
                idx(strcmpi(names, 'Current Designs, Inc. 932')),...
                idx(strcmpi(names, 'Apple Internal Keyboard / Trackpad')),...
                idx(strcmpi(names, ''))];
    ...
    info.kbqdev = [idx(strcmpi(names, 'Apple Internal Keyboard / Trackpad')),...
        idx(strcmpi(names, 'Magic Keyboard')),idx(strcmpi(names, 'DELL Dell USB Entry Keyboard')),...
        idx(strcmpi(names, ''))];
