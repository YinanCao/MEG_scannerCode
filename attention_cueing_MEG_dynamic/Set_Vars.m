...
Trial.cueD                 = 0.1; % cue duration
Trial.cue2StimD            = 0.35;
Trial.stim2newcue          = 0.25 + (1-0.25)*rand(nTrials,1);
Trial.stim2dot             = 1.3 + (1.9-1.3)*rand(nTrials,1);
Trial.dotD                 = ndotFrames*(ifi);
Trial.SD                   = 2;% Stimulus duration
Trial.s2PD                 = 0.5;
Trial.ProbD                = 0.5;
